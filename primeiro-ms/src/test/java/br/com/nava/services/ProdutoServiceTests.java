...
public class ProdutoServiceTests {
	...
	void getOneWhenFoundObjectTest() {
		...
		Optional<ProdutoEntity> opcional = Optional.of(produtoEntidade);
		
		when (produtoRepository.findById(1)).thenReturn(opcional);
	...
	void getOneWhenNotFoundObjectTest() {
		...
		Optional<ProdutoEntity> opcional = Optional.empty();
